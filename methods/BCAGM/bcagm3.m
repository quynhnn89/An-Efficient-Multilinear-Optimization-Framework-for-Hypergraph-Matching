function [X, objs, nIter] = bcagm3(alg, problem, X0, maxIter, adapt)
%
% Multilinear Solver
%
if alg.bOrder(1)
...
[X, objs, nIter] = mexBCAGM3Matching(int32(indH1'), double(valH1),...
                                    int32(indH2'), double(valH2),...
                                    int32(indH3'), double(valH3),...
                                    int32(N1), int32(N2), double(X0), int32(maxIter), int32(adapt));
