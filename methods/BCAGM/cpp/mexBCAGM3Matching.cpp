...
void mexFunction( int nlhs, mxArray *plhs[],
    ...
    enum{ indH1i, valH1i, indH2i, valH2i, indH3i, valH3i, N1i, N2i, X0i, maxIteri, adapti};
    ...
    double* X0 = oliCheckArg(prhs, X0i, N1*N2*3, 1, oliDouble);
    int* maxIter = (int*)oliCheckArg(prhs, maxIteri, 1, 1, oliInt);
    ...
    if (*adapt <= 0) {
        bcagm3(indH1, valH1, Nt1,
                    indH2, valH2, Nt2,
                    indH3, valH3, Nt3,
                    X0, N1, N2, *maxIter, 
                    Xout, objs, nIter);
    } else {
        adapt_bcagm3(	indH1, valH1, Nt1,
                indH2, valH2, Nt2,
                indH3, valH3, Nt3,
                X0, N1, N2, *maxIter, *adapt,
                Xout, objs, nIter);
    }
}
